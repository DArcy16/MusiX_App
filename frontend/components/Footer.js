      ...
      {currentlyPlayingSong.id !== "" ? (
        loading ? null : (
          <div className="absolute -top-12 md:-top-16">
            <Link href="/player">
              <MdOutlineKeyboardArrowUp className="mx-auto w-8 h-8 md:w-12 md:h-12 -mb-1 md:-mb-3 hover:scale-105" />
            </Link>
            <div className="w-14 h-14 md:w-20 md:h-20 rounded-full object-fit relative flex items-center justify-center">
              ...
              ></img>
              <ImCross
                className="absolute w-8 h-8 text-white/70 text-gray hover:scale-105 cursor-pointer"
                onClick={() => {
